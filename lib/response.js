...
response.init = function(app, settings) {
    ...
    var render = function (view, options, fn) {
        ...
        var render_toolbar = function (str, callback) {
            var opts = {
                ...
                panels:      panels.render({
                    ...
                    req:    req,
                    view:   view
                }, settings, settings.path === req.path)
            };
        ...
        if (req.path === settings.path) {
            ...
            res._EDT_orig_render.apply(res, [view, options, toolbar_callback]);
        }
    };
...
//            request.add(this);
        ...
        this._EDT_orig_end.apply(this, arguments);
    };

    response.patch = function(res) {
        res._EDT_orig_render = res.render;
        res.render = render;
        res._EDT_orig_end = res.end;
        res.end = end;
    }
};